    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Club Motor "Bersama Menjelajah"</h1>
          <h2>Menjelajahi Nusantara, Merajut Persaudaraan</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 d-flex justify-content-center video-box align-items-stretch position-relative">
            <a href="https://www.youtube.com/watch?v=w05sKRSJrbY" class="glightbox play-btn mb-4"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>Visi</h3>
            <p>Menjadi komunitas motor terdepan dalam menjalin persaudaraan, menjelajahi keindahan alam nusantara, dan berbagi pengalaman berkendara yang aman dan menyenangkan.</p>

            <h3 class="pt-3">Misi</h3>
            <div class="icon-box">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title pt-3">Meningkatkan rasa persaudaraan dan kebersamaan antar pecinta motor.</h4>
            </div>

            <div class="icon-box">
              <div class="icon"><i class="bx bx-gift"></i></div>
              <h4 class="title pt-3">Menjelajahi keindahan alam nusantara dan mempromosikan pariwisata Indonesia.</h4>
            </div>

            <div class="icon-box">
              <div class="icon"><i class="bx bx-atom"></i></div>
              <h4 class="title pt-3">Berbagi pengalaman berkendara yang aman dan menyenangkan.</h4>
            </div>
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="text-center title">
          <h3>Kegiatan</h3>
          <p>Club Motor "Bersama Menjelajah" aktif melakukan berbagai kegiatan, antara lain:</p>
        </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-1.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-2.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-3.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-4.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-5.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-6.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-7.jpg" class="galleery-lightbox" data-gallery="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="asset/img/gallery/gallery-8.jpg" class="galleery-lightbox" data-gallery="gallery-item">
